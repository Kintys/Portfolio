...
***************************************************************************** */
    ...
    function documentActions(e) {
        ...
        if (targetElement.closest(`.body-product__add-to-cart-button`)) {
            addToCard();
            e.preventDefault();
        }
        function addToCard() {
            ...
            const headerCartQuant = headerCart.querySelector(`span`);
            const poductImage = document.querySelector(`.images-product__slide.swiper-slide-active img`);
            ...
            const imageFly = poductImage.cloneNode(true);
            ...
            imageFlyBlock.style.cssText = `\n                top: ${poductImage.getBoundingClientRect().top}px;\n                left: ${poductImage.getBoundingClientRect().left}px;\n                width: ${poductImage.offsetWidth}px;\n                height: ${poductImage.offsetHeight}px;\n                `;
            setTimeout((() => {
                imageFlyBlock.style.cssText = `\n                top: ${headerCart.getBoundingClientRect().top}px;\n                left: ${headerCart.getBoundingClientRect().left}px;\n                width: 0;\n                height: 0;\n                opacity: 0;\n                transition: all ${speed}ms ease 0s;\n        `;
            }), 5);
            setTimeout((() => {
                headerCartQuant.innerHTML = +headerCartQuant.innerHTML + +productQuantity;
